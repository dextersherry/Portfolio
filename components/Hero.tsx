        ...
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black-100 bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]" />
           <div className='flex justify-center relative my-20 z-10'>
                ...
                <div className='max-w-[89vw] md:max-w-xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                                    ...
                                    text-center text-xs text-blue-100
                                    max-w-80'>Dynamic web magic
                                    </h2>

                                    <TextGenerateEffect
                                    className='text-center text-[40px] md:text-5xl lg:text-6xl capitalize'
                                     words={'Welcome to the portfolio of shresth sharma'}/>

                          
                          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl capitalize'>
                            Hi , I&apos;m  Shresth , A full-stack web developer from India </p> 
